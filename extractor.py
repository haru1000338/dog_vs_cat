...
import numpy as np
from dog_vs_cat.smallcnn import save_history

img_width, img_height = 150, 150
train_data_dir = 'data/train'
validation_data_dir = 'data/validation'
nb_train_samples = 2000  # 訓練データ数
nb_validation_samples = 800  # 検証データ数（性能チェック用）
nb_epoch = 50  # 訓練データを50周モデルに学習させる
...
def train_top_model():
    ...
    model.save_weights(os.path.join(result_dir, 'bottleneck_fc_model.weights.h5'))
