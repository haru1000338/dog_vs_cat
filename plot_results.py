...
result_file1 = os.path.join(f"{result_dir}/history_smallcnn.txt")
result_file2 = os.path.join(f"{result_dir}/history_extractor.txt")
result_file3 = os.path.join(f"{result_dir}/history_finetuning.txt")
result_file4 = os.path.join(f"{result_dir}/history_finetuning_from_random.txt")
